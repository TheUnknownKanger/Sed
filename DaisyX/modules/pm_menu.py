...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://t.me/lucifeermorningstar"
        ),
    )
    buttons.add(
        InlineKeyboardButton(strings["btn_channel"], url="https://t.me/DaisyXNews"),
        InlineKeyboardButton("👥 Support Group", url="https://t.me/DaisyXSupport"),
    )
    buttons.add(
        InlineKeyboardButton(
            "👸🏼 Add DaisyX to your group",
            url=f"https://telegram.me/missdaisyx_bot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/MissDaisyX_BOT?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
